...
export class TyphoonUpdatedListener {
  ...
  async handleTyphoonUpdatedEvent(event: GDASCTyphoonUpdatedEvent) {
    ...
    // 입력 값 예시
    // 2021-09-01 00:00:00 태풍이 발생함. 태풍 정보 업데이트. 0시
    // 2021-09-01 00:00:00 1시간뒤 크롤링. 1시
    // 2021-09-01 00:00:00 2시간뒤 크롤링. 2시
    // 2021-09-01 00:00:00 3시간뒤 크롤링. 3시
    // 2021-09-01 00:00:00 4시간뒤 크롤링. 4시
    // 2021-09-01 00:00:00 5시간뒤 크롤링. 5시

    // 2021-09-01 06:00:00 6시간뒤 크롤링. 태풍 정보 업데이트. 6시
    // 2021-09-01 06:00:00 7시간뒤 크롤링. 7시
    // 2021-09-01 06:00:00 8시간뒤 크롤링. 8시

    // 2021-09-01 09:00:00 9시간뒤 크롤링. 태풍 정보 업데이트.  9시
    // 2021-09-01 09:00:00 10시간뒤 크롤링. 10시
    ...
    if (exist.historical_details.length > 0) {
      this.logger.log(
        `태풍 정보 업데이트 안됨 :: typhoon_id: ${event.id}, envent_date: ${event.date}`,
      );
      return;
    }
